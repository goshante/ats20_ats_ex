...
**Последняя версия:** v1.06 (06.03.2024)

**Ссылка на скачивание готового .hex файла прошивки:** [>>> Нажмите здесь <<<](https://github.com/goshante/ats20_ats_ex/releases/download/v1.06/ATS_EX_v1.06.hex)
...
#### Кнопка **AGC** 
 1. **Включение/выключение дисплея** : Короткое нажатие для работает как выключатель дисплея. 
