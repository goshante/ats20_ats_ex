...
**Последняя версия:** v1.08 (07.03.2024)

**Ссылка на скачивание готового .hex файла прошивки:** [>>> Нажмите здесь <<<](https://github.com/goshante/ats20_ats_ex/releases/download/v1.08/ATS_EX_v1.08.hex)
...
# Особенности
 ...
 - **LW** Диапазон: От **153** (или **138** в режиме SSB) to **520** KГц
...
### Функционал кнопок
#### Кнопка **BAND+** 
 1. **Выбор диапазона** : Короткое нажатие для входа в режим выбора диапазона. Выберите диапазон с помощью **Вращения Энкодера** и подтвердите с помощью **Кнопки Энкодера** или повторным нажатием кнопки **BAND+**. Либо **BAND+** зажмите для быстрой прокрутки диапазонов вперёд.
 2. **Переключение страницы настроек** : Данная кнопка переключает **страницы настроек** во время того, как открыты настройки.
#### Кнопка **BAND-** 
 1. **Меню настроек** : Короткое нажатие для открытия/закрытия **меню настроек**.
...
#### Кнопка **STEP**
 ...
 2. **Шкала уровня сигнала** : Длинное нажатие клавиши показывает снизу полосу уровня сигнала, **подобную S-метру**. Можно выключить повторым длинным или коротким нажатием. Либо сменой диапазона.
#### Кнопка **AGC** 
...
#### **Кнопка Энкодера**
1. **Сканирование частоты** : Работает **только в FM и АМ** модуляциях. Нажмите, чтобы сканировать станции по частоте в последнем направлении с заданным шагом.
...
4. **Быстрая настройка шага в SSB** : Только для SSB режима - нажатие позволяет сразу перейти в режим настройки шага.
