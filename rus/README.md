...
**Последняя версия:** v1.11 (09.03.2024)

**Ссылка на скачивание готового .hex файла прошивки:** [>>> Нажмите здесь <<<](https://github.com/goshante/ats20_ats_ex/releases/download/v1.11/ATS_EX_v1.11.hex)
...
# Особенности
 ...
 - **LW** Диапазон: От **153** (или **138** в режиме SSB) до **520** KГц
 - **MW** Диапазон: От **520** до **1710** KГц
 - **SW** Диапазон: От **1700** до **30000** КГц (С большим количеством поддиапазонов)
...
#### Кнопка **BAND-** 
 1. **Меню настроек** : Короткое нажатие для открытия/закрытия **меню настроек**. При **закрытии** настроек, все настройки **сохраняются в EEEPROM**.
